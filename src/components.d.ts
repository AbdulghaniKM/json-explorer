...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    JsonLineViewer: typeof import('./components/json/LineViewer.vue')['default']
    JsonOutput: typeof import('./components/json/Output.vue')['default']
    JsonPanel: typeof import('./components/json/Panel.vue')['default']
    JsonSplitPane: typeof import('./components/json/SplitPane.vue')['default']
    ...
    JsonWorkbench: typeof import('./components/json/Workbench.vue')['default']
    LandingMatrixRain: typeof import('./components/landing/MatrixRain.vue')['default']
    LandingMatrixText: typeof import('./components/landing/MatrixText.vue')['default']
